...
import com.example.eugene.advancedandroid.test.ControllerTest;
...
public class TrendingReposControllerTest extends ControllerTest {
    ...
    public void loadRepos() {
        ...
        onView(allOf(withId(R.id.tv_repo_name),
                withText("RxJava"))).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.VISIBLE)));
