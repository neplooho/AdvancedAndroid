...
public abstract class Repo {
    ...
    /*
    * These have same method names as fields in json
    * So no need in @Json annotation
    * */
    ...
    /*
    * These methods don't have corresponding fields in json (by their name)
    * So we use @Json annotation to tell what fields they should operate on
    * */
